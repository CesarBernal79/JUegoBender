...
const palabras = ['Estonia', 'Turquia', 'Vietnam', 'Suecia', 'Chile', 'Serbia', 'Camerun', 'Congo', 'Uruguay','Haiti', 'Kuwait', 'Alaska', 'Catar', 'Egipto', 'Escocia', 'Angola','Andorra', 'Chipre','Etiopia', 'Uganda',];
const btn = id('jugar');
